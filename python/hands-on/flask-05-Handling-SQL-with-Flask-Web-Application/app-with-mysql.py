...
app.config['MYSQL_DATABASE_HOST'] = 'gokturk-web-users-db.ca64ehyggu4b.us-east-1.rds.amazonaws.com'
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'Gokturk_1'
app.config['MYSQL_DATABASE_DB'] = 'kullanici'
...
"""
data = """
INSERT INTO kullanici.users 
VALUES 
    ("Gokturk", "gokturk@amazon.com" ),
	("Murat", "murat@microsoft.com"),
	("Mustafa", "mustafa@facebook.com"),
    ("Seda", "seda@tesla.com"), 
    ("Melek","melek@bmw.com");
"""
